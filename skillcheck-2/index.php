  ...
  <div class="container_form">
      <div class="name">
        <label for="name"></label>
            <input type="text" placeholder="Name" name="name" id="inputName" value="<?php echo htmlspecialchars($post['name']); ?>" required autofocus>
        <!-- エラーメッセージ -->
      ...
      <div class="email">
        <label for="email"></label>
            <input type="email" placeholder="E-mail" name="email" id="inputEmail" value="<?php echo htmlspecialchars($post['email']); ?>" required>
        <!-- エラーメッセージ -->
      ...
      <div class="telephone">
        <label for="name"></label>
          <input type="text" placeholder="Tel" name="tel" id="inputTel" value="<?php echo htmlspecialchars($post['tel']); ?>" required>
        <!-- エラーメッセージ -->
      ...
      <div class="subject">
        <select name="item" id="inputItem" value="<?php echo htmlspecialchars($post['item']); ?>" required autofocus>
      ...
      <div class="message">
        <label for="message">Message</label>
            <textarea name="contact" id="inputContent" rows="10" required><?php echo htmlspecialchars($post['contact']); ?></textarea>
        <!-- エラーメッセージ -->
